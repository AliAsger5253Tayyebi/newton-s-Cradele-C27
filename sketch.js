...
function keyPressed()	{
	if(keyCode===UP_ARROW)	{
		Matter.Body.applyForce(bob5.body,bob5.body.position,{x:15,y:-10});
	}
		...
		if(keyCode=== RIGHT_ARROW)	{
			Matter.Body.applyForce(bob5.body,bob5.body.position,{x:15,y:-10});
			Matter.Body.applyForce(bob4.body,bob4.body.position,{x:15,y:-10});
		}
		if(keyCode=== LEFT_ARROW)	{
			Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-15,y:10});
			Matter.Body.applyForce(bob2.body,bob2.body.position,{x:-15,y:10});
		}
}
